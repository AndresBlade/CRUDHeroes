	...
	public partial class RegistroPelicula : Form
	{
		...
		private void peliculas_AddingNew(object sender, AddingNewEventArgs e)
		{
			e.NewObject = new Pelicula {
				...
				Personajes = clonPersonajes(pelicula.Personajes)
		...
		private List<Personaje> clonPersonajes(List<Personaje>personajes)
		{
			List<Personaje> clon = new List<Personaje>();
		...
		private void buttonBuscarPelicula_Click(object sender, EventArgs e)
		{
			...
			List<Personaje> personajesListBox = new List<Personaje>();

			foreach (Personaje item in checkedListBoxPersonajes.Items)
			{
				personajesListBox.Add(item);
			}

			foreach (Personaje personaje in peliculaBuscada.Personajes)
			{
			...
			pelicula.Personajes = clonPersonajes(peliculaBuscada.Personajes);
		...
		{
			Personaje personaje = (Personaje)checkedListBoxPersonajes.Items[e.Index];
